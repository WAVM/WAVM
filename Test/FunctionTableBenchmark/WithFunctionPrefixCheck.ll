...
loop:                                             ; preds = %ifElse9, %_func13.exit
  ...
  %_local3.0 = phi i32 [ 0, %_func13.exit ], [ %31, %ifElse9 ]
  br label %loop1
...
loop6:                                            ; preds = %loop1, %loop6
  ...
  %26 = icmp eq i32 %25, 0
  %27 = select i1 %26, i32 ()* %22, i32 ()* @_func52
  %28 = call i32 %27()
  %29 = add i32 %28, %_local0.1
  %lsr.iv.next21 = add i32 %lsr.iv20, 4
  %lsr.iv.next23 = add nsw i64 %lsr.iv22, -1
  %30 = icmp eq i64 %lsr.iv.next23, 0
  br i1 %30, label %ifElse9, label %loop6

ifElse9:                                          ; preds = %loop6
  %.lcssa = phi i32 [ %29, %loop6 ]
  %31 = add nuw nsw i32 %_local3.0, 1
  %32 = icmp eq i32 %31, 1000000
  br i1 %32, label %ifElse12, label %loop
