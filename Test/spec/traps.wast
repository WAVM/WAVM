...
(module
    ...
    (func $i32.load (param $i i32) (i32.load (i32.add (memory_size) (get_local $i))))
    (export "i64.load" $i64.load)
    (func $i64.load (param $i i32) (i64.load (i32.add (memory_size) (get_local $i))))
    (export "f32.load" $f32.load)
    (func $f32.load (param $i i32) (f32.load (i32.add (memory_size) (get_local $i))))
    (export "f64.load" $f64.load)
    (func $f64.load (param $i i32) (f64.load (i32.add (memory_size) (get_local $i))))
)
