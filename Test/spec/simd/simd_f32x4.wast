...
(module
  ...
  (func (export "f32x4.max_with_const_4") (result v128) (f32x4.max (v128.const f32x4 0 1 2 -3) (v128.const f32x4 0 2 1 3)))
  (func (export "f32x4.max_with_const_5") (result v128) (f32x4.max (v128.const f32x4 0 1 2 3) (v128.const f32x4 0 1 2 3)))
  (func (export "f32x4.max_with_const_6") (result v128) (f32x4.max (v128.const f32x4 0x00 0x01 0x02 0x80000000) (v128.const f32x4 0x00 0x02 0x01 2147483648)))
  (func (export "f32x4.max_with_const_7") (result v128) (f32x4.max (v128.const f32x4 0x00 0x01 0x02 0x80000000) (v128.const f32x4 0x00 0x01 0x02 0x80000000)))
  (func (export "f32x4.abs_with_const_8") (result v128) (f32x4.abs (v128.const f32x4 -0 -1 -2 -3)))
)
...
(assert_return (invoke "f32x4.max_with_const_4") (v128.const f32x4 0 2 2 3))
(assert_return (invoke "f32x4.max_with_const_5") (v128.const f32x4 0 1 2 3))
(assert_return (invoke "f32x4.max_with_const_6") (v128.const f32x4 0x00 0x02 0x02 2147483648))
(assert_return (invoke "f32x4.max_with_const_7") (v128.const f32x4 0x00 0x01 0x02 0x80000000))
(assert_return (invoke "f32x4.abs_with_const_8") (v128.const f32x4 0 1 2 3))
...
(assert_return (invoke "f32x4.min" (v128.const f32x4 nan 0 0 1)
                                   (v128.const f32x4 0 -nan 1 0))
                                   (v128.const f32x4 nan -nan 0 0))
(assert_return (invoke "f32x4.min" (v128.const f32x4 nan 0 0 0)
                                   (v128.const f32x4 0 -nan 1 0))
                                   (v128.const f32x4 nan -nan 0 0))
(assert_return (invoke "f32x4.max" (v128.const f32x4 nan 0 0 1)
                                   (v128.const f32x4 0 -nan 1 0))
                                   (v128.const f32x4 nan -nan 1 1))
(assert_return (invoke "f32x4.max" (v128.const f32x4 nan 0 0 0)
                                   (v128.const f32x4 0 -nan 1 0))
                                   (v128.const f32x4 nan -nan 1 0))
