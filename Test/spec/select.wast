(module
  ...
  (memory 1)
  (func $dummy)
  (table $tab anyfunc (elem $dummy $func))
  ...
  (func (export "as-call_indirect-first") (param i32) (result i32)
    (block (result i32)
      (call_indirect (type $check)
        (select (i32.const 2) (i32.const 3) (get_local 0)) (i32.const 1) (i32.const 1)
      )
    )
  )
  (func (export "as-call_indirect-mid") (param i32) (result i32)
    (block (result i32)
      (call_indirect (type $check)
        (i32.const 1) (select (i32.const 2) (i32.const 3) (get_local 0)) (i32.const 1)
      )
    )
  )
