...
(invoke "init" (i64.const 0) (i64.const 1) (i64.const 2))
...
(invoke "init" (i64.const 0xfffc) (i64.const 0) (i64.const 4))

;; Out-of-bounds writes trap, and no partial writes has been made.
(assert_trap (invoke "init" (i64.const 0xfffe) (i64.const 0) (i64.const 3))
    "out of bounds")
...
(invoke "init" (i64.const 0x10000) (i64.const 0) (i64.const 0))
(invoke "init" (i64.const 0) (i64.const 4) (i64.const 0))

;; Writing 0 bytes outside of memory / segment limit is NOT allowed.
(assert_trap
  (invoke "init" (i64.const 0x10001) (i64.const 0) (i64.const 0))
  "out of bounds")
(assert_trap
  (invoke "init" (i64.const 0) (i64.const 5) (i64.const 0))
  "out of bounds")

;; OK to access 0 bytes at offset 0 in a dropped segment.
(invoke "init" (i64.const 0) (i64.const 0) (i64.const 0))
...
(module
  ...
  (func (export "init_passive")
    (memory.init 0 (i64.const 0) (i64.const 0) (i64.const 0)))

  (func (export "drop_active") (data.drop 1))
  (func (export "init_active")
    (memory.init 1 (i64.const 0) (i64.const 0) (i64.const 0)))
)
