...
(module
	...
	(func $compress
		...
		(local.set $row4l (v8x16.shuffle (4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11) (local.get $row4l) (v128.const i64 0 0)))
		(local.set $row4h (v8x16.shuffle (4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11) (local.get $row4h) (v128.const i64 0 0)))
		...
		(local.set $row2l (v8x16.shuffle (3 4 5 6 7 0 1 2 11 12 13 14 15 8 9 10) (local.get $row2l) (v128.const i64 0 0)))
		(local.set $row2h (v8x16.shuffle (3 4 5 6 7 0 1 2 11 12 13 14 15 8 9 10) (local.get $row2h) (v128.const i64 0 0)))
		...
		(local.set $row4l (v128.xor (local.get $row4l) (local.get $row1l)))
		(local.set $row4h (v128.xor (local.get $row4h) (local.get $row1h)))
		(local.set $row4l (v8x16.shuffle (2 3 4 5 6 7 0 1 10 11 12 13 14 15 8 9) (local.get $row4l) (v128.const i64 0 0)))
		(local.set $row4h (v8x16.shuffle (2 3 4 5 6 7 0 1 10 11 12 13 14 15 8 9) (local.get $row4h) (v128.const i64 0 0)))
		(local.set $row3l (i64x2.add (local.get $row3l) (local.get $row4l)))
		(local.set $row3h (i64x2.add (local.get $row3h) (local.get $row4h)))
		(local.set $row2l (v128.xor (local.get $row2l) (local.get $row3l)))
		(local.set $row2h (v128.xor (local.get $row2h) (local.get $row3h)))
		(local.set $row2l (v128.xor (i64x2.shr_u (local.get $row2l) (i64x2.splat (i64.const 63))) (i64x2.add (local.get $row2l) (local.get $row2l))))
		(local.set $row2h (v128.xor (i64x2.shr_u (local.get $row2h) (i64x2.splat (i64.const 63))) (i64x2.add (local.get $row2h) (local.get $row2h))))
		...
		(local.set $b0 (v8x16.shuffle (8 9 10 11 12 13 14 15 0 1 2 3 4 5 6 7) (v128.load offset=0 (local.get $blockAddress)) (v128.const i64 0 0)))
		...
		(local.set $b1 (v128.bitselect (v128.load offset=16 (local.get $blockAddress)) (v128.load offset=96 (local.get $blockAddress)) (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=80 (local.get $blockAddress)) (v128.load offset=16 (local.get $blockAddress)) (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=16 (local.get $blockAddress)) (v128.load offset=32 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		(local.set $b1 (v128.bitselect (v128.load offset=32 (local.get $blockAddress)) (v128.load offset=112 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=0 (local.get $blockAddress)) (v128.load offset=48 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		(local.set $b1 (v128.bitselect (v128.load offset=32 (local.get $blockAddress)) (v128.load offset=112 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=112 (local.get $blockAddress)) (v128.load offset=80 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		(local.set $b1 (v128.bitselect (v128.load offset=48 (local.get $blockAddress)) (v128.load offset=16 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b1 (v128.bitselect (v128.load offset=64 (local.get $blockAddress)) (v128.load offset=96 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=32 (local.get $blockAddress)) (v128.load offset=48 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b1 (v128.bitselect (v128.load offset=112 (local.get $blockAddress)) (v128.load offset=64 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=96 (local.get $blockAddress)) (v128.load offset=0 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b1 (v8x16.shuffle (8 9 10 11 12 13 14 15 0 1 2 3 4 5 6 7) (v128.load offset=64 (local.get $blockAddress)) (v128.const i64 0 0)))
		...
		(local.set $b0 (v8x16.shuffle (8 9 10 11 12 13 14 15 24 25 26 27 28 29 30 31) (v128.load offset=48 (local.get $blockAddress)) (v128.load offset=16 (local.get $blockAddress))))
		(local.set $b1 (v128.bitselect (v128.load offset=16 (local.get $blockAddress)) (v128.load offset=80 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b1 (v128.bitselect (v128.load offset=96 (local.get $blockAddress)) (v128.load offset=16 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b0 (v128.bitselect (v128.load offset=16 (local.get $blockAddress)) (v128.load offset=48 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
		...
		(local.set $b1 (v128.bitselect (v128.load offset=48 (local.get $blockAddress)) (v128.load offset=32 (local.get $blockAddress))  (v128.const i64 0xffffffffffffffff 0)))
