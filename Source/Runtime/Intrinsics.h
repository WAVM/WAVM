...
#define DEFINE_INTRINSIC_FUNCTION0(module,name,returnType) \
	...
	static Intrinsics::Function name##Intrinsic(#module "." #name,AST::FunctionType(AST::TypeId::returnType),(void*)&name##IntrinsicFunc); \
	AST::NativeTypes::returnType name##IntrinsicFunc()
...
#define DEFINE_INTRINSIC_FUNCTION1(module,name,returnType,arg0Type,arg0Name) \
	...
	static Intrinsics::Function name##Intrinsic(#module "." #name,AST::FunctionType(AST::TypeId::returnType,{AST::TypeId::arg0Type}),(void*)&name##IntrinsicFunc); \
...
#define DEFINE_INTRINSIC_FUNCTION2(module,name,returnType,arg0Type,arg0Name,arg1Type,arg1Name) \
	...
	static Intrinsics::Function name##Function(#module "." #name,AST::FunctionType(AST::TypeId::returnType,{AST::TypeId::arg0Type,AST::TypeId::arg1Type}),(void*)&name##IntrinsicFunc); \
...
#define DEFINE_INTRINSIC_FUNCTION3(module,name,returnType,arg0Type,arg0Name,arg1Type,arg1Name,arg2Type,arg2Name) \
	...
	static Intrinsics::Function name##Function(#module "." #name,AST::FunctionType(AST::TypeId::returnType,{AST::TypeId::arg0Type,AST::TypeId::arg1Type,AST::TypeId::arg2Type}),(void*)&name##IntrinsicFunc); \
...
#define DEFINE_INTRINSIC_FUNCTION4(module,name,returnType,arg0Type,arg0Name,arg1Type,arg1Name,arg2Type,arg2Name,arg3Type,arg3Name) \
	...
	static Intrinsics::Function name##Function(#module "." #name,AST::FunctionType(AST::TypeId::returnType,{AST::TypeId::arg0Type,AST::TypeId::arg1Type,AST::TypeId::arg2Type,AST::TypeId::arg3Type}),(void*)&name##IntrinsicFunc); \
...
#define DEFINE_INTRINSIC_FUNCTION5(module,name,returnType,arg0Type,arg0Name,arg1Type,arg1Name,arg2Type,arg2Name,arg3Type,arg3Name,arg4Type,arg4Name) \
	...
	static Intrinsics::Function name##Function(#module "." #name,AST::FunctionType(AST::TypeId::returnType,{AST::TypeId::arg0Type,AST::TypeId::arg1Type,AST::TypeId::arg2Type,AST::TypeId::arg3Type,AST::TypeId::arg4Type}),(void*)&name##IntrinsicFunc); \
