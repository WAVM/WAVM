...
template<>              inline U32  XXH<U32>(const void* data, Uptr numBytes, U32  seed) { return XXH32(data, numBytes, seed); }
template<>              inline U64  XXH<U64>(const void* data, Uptr numBytes, U64  seed) { return XXH64(data, numBytes, seed); }

template<> struct Hash<U8>  { Uptr operator()(U8 i,  Uptr seed = 0) const { return Uptr(XXH32_fixed(U32(i),U32(seed))); } };
template<> struct Hash<I8>  { Uptr operator()(I8 i,  Uptr seed = 0) const { return Uptr(XXH32_fixed(I32(i),U32(seed))); } };
template<> struct Hash<U16> { Uptr operator()(U16 i, Uptr seed = 0) const { return Uptr(XXH32_fixed(U32(i),U32(seed))); } };
template<> struct Hash<I16> { Uptr operator()(I16 i, Uptr seed = 0) const { return Uptr(XXH32_fixed(I32(i),U32(seed))); } };
template<> struct Hash<U32> { Uptr operator()(U32 i, Uptr seed = 0) const { return Uptr(XXH32_fixed(U32(i),U32(seed))); } };
template<> struct Hash<I32> { Uptr operator()(I32 i, Uptr seed = 0) const { return Uptr(XXH32_fixed(I32(i),U32(seed))); } };
template<> struct Hash<U64> { Uptr operator()(U64 i, Uptr seed = 0) const { return Uptr(XXH64_fixed(U64(i),U64(seed))); } };
template<> struct Hash<I64> { Uptr operator()(I64 i, Uptr seed = 0) const { return Uptr(XXH64_fixed(I64(i),U64(seed))); } };
